...
| **Error Correction** | Reliability-ordered soft-decision 1-bit correction | Evaluates lowest-confidence soft-decision metrics on CRC mismatch |
...
Input Audio ──► Multi-Channel Downmix ──► Frame Folding (Modulo Geometry)
                                                     │
                                                     ▼
Confidence Verdict ◄── Z-Score ◄── Eb/N0 Metric ◄── Fractional Resync Grid
```
...
5. **Physical Signal-to-Noise Ratio ($E_b/N_0$ & SQNR):**
